        ...
        <div style={{ padding: "20px 24px", overflowY: "auto" }}>
          ...
          {step === 2 && <>
            ...
            <div style={{ marginTop: 16 }}>
              <label style={{ fontSize: 11, color: "#b08080", textTransform: "uppercase", letterSpacing: ".5px", display: "block", marginBottom: 6 }}>Upload payment screenshot <span style={{ color: "#c09090", textTransform: "none", fontSize: 12 }}>
            ...
            <div style={{ background: "#fceaea", borderRadius: 12, padding: "10px 14px", fontSize: 12, color: "#8a5858", marginTop: 14, lineHeight: 1.6 }}>            <div style={{ display: "flex", gap: 10, marginTop: 12 }}>
